...
function controlInteraction() {
  ...
  if (userDataControl[5] != null) {
    ...
    setTimeout(function () {
      areaMessages.innerHTML += `<p class="bot-message">Your BMI is <span class="info">${userBMI} kg/m² - ${resultBMI}</span></p><br>`;
      scrollDiv();
    }, 22000);
    ...
    case 'Normal weight':
        ...
        break;
    case 'Overweight':
        areaMessages.innerHTML += `<p class="bot-message">Unfortunately, you are slightly above your ideal weight, where the average is <span class="info">${idealWeight} Kg &#128533</span></p><br>`;
        scrollDiv();
        break;
    ...
    case 'Obesity Grade 3':
        areaMessages.innerHTML += `<p class="bot-message">Unfortunately, you are significantly above your ideal weight, where the average is <span class="info">${idealWeight} Kg &#128533</span></p><br>`;
        scrollDiv();
        break;
}
    ...
    setTimeout(function () {
      areaMessages.innerHTML += `<p class="credits">Thank you for using our app</p>`;
      scrollDiv();
    }, 51000);
  }
